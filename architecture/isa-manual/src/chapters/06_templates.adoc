...
NOTE: For `TemplateKind.class=1` (TEPL templates), identification uses the `TileOp10` selector (not this enum).
...
golden sources (`isa/v0.3/`) and the canonical catalog (`isa/v0.3/linxisa-v0.3.json`).
